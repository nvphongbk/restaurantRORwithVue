    ...
    <!--&lt;!&ndash;fitter cooking&ndash;&gt;-->
      ...
      <!--<div class="my-5">-->
        <!--<a-select style="width: 300px"-->
                  ...
                  <!--placeholder="Chọn cách nấu món ăn"-->
                  <!--@change="handleChange"-->
        <!--&gt;-->
            <!--<a-select-option v-for="(cookingMethod, index) in menu.cooking_methods" :value="cookingMethod.name"-->
                             <!--:key="index">-->
              <!--{{ cookingMethod.name }}-->
            <!--</a-select-option>-->
        <!--</a-select>-->
  ...
  <!--export default {-->
    ...
    <!--methods: {-->
      ...
      <!--handleChange(value) {-->
        <!--if(value){-->
          <!--console.log(value)-->
          <!--return this.menu.cooking_methods.filter((item)=>{-->
